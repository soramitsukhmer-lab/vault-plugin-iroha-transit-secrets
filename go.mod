...
replace github.com/hashicorp/vault => github.com/soramitsukhmer-lab/vault v1.17.6-iroha-transit-1

replace github.com/hashicorp/vault/api => github.com/soramitsukhmer-lab/vault/api v1.17.6-iroha-transit-1
